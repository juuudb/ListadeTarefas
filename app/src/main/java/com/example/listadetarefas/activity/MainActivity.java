...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ContentValues cv = new ContentValues(); // define itens como se fosse array
        //cv.put("nome", "Teste");

        //db.getWritableDatabase().insert("tarefas", null, cv); // escrita no banco de ddados, insere dados
                ...
                new RecyclerItemClickListener(
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                //Recuperando tareaf para edição
                            ...
                            public void onLongItemClick(View view, int position) {
                                ...
                                //Recupera Tarefa a ser deletada pelo usuario
